...
OnOS Technology is an innovative startup delivering end-to-end digital solutions, including system development, web and software engineering, cloud computing, and AI-driven technologies.

---

## 👨‍💻 About Us
- 🚀 Startup focused on modern tech solutions  
- ⚡ Focus: `Next.js` `Node.js` `Prisma` `Docker` `Cloud`  
- 🤖 Working on **AI agents + automation systems**  
- 🖥️ Specialized in **System & Web Development**  
...
### 💻 Languages
![Languages](https://skillicons.dev/icons?i=js,ts,python,php,go,java,bash)

### 🎨 Frontend Development
![Frontend](https://skillicons.dev/icons?i=react,nextjs,vue,tailwind,html,css)

### ⚙️ Backend Development
![Backend](https://skillicons.dev/icons?i=nodejs,express,nestjs,laravel)

### 🛢️ Databases & ORM
![Database](https://skillicons.dev/icons?i=mysql,postgres,mongodb,redis,prisma)

### ☁️ Cloud & DevOps
![DevOps](https://skillicons.dev/icons?i=docker,kubernetes,aws,nginx,linux,git,githubactions)
...
### 🔧 Tools & Platforms
![Tools](https://skillicons.dev/icons?i=vercel,cloudflare,firebase,supabase,postman)
